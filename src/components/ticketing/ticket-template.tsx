...
export function TicketTemplate(props: TicketTemplateProps) {
  ...
  return (
    <>
      ...
      `}</style>
      <div id="ticket-to-print" className="bg-background p-4 sm:p-8 flex items-center justify-center min-h-[calc(100vh-4rem)] print:min-h-screen print:p-0">
          <div className="w-full max-w-md mx-auto p-6 border-2 border-primary bg-card text-card-foreground rounded-lg shadow-2xl relative overflow-hidden print:border-none print:shadow-none print:rounded-none">
              ...
              <div className="relative text-center space-y-4">
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row gap-2 no-print">
